...
VALUES
  (
    'FR00000012',
    'hPhân bón Đầu Trâu ĐB - MK NPK 16-16-8+TE',
...
VALUES
  (
    'PE00000012',
    'SIÊU SẠCH CHÍCH HÚT BỌ NHẢY,RẦY NÂU,RỆP SÁP',
    'Công ty CP hóa sinh Akai Bara Việt Nam',
    'Chuyên trị những loại chích hút,thuôc có tác dụng tiếp xúc,vị độc,nội hấp đồng thời xông hơi nhẹ hiệu quả rất cao với những loại côn trùng: bọ nhảy,bọ trĩ,rầy nâu,rầy cánh trắng,rệp sáp,rầy bông xoài...thuôc lưu dẫn nhanh,mạnh,an toàn với môi trường và thiên dịch',
    'pha gói 15g cho 100- 200 lít nước.lượng nước phun 320 lít/ ha. Phun ướt đều cây,khi dịch hại sớm xuất hiện. Phun thuôc khi rầy cám nở rộ',
    'Dinotefuran  20%. Wetting agent  2%. Dispersing agent 2%'
  );
INSERT INTO
  `pesticide` (
    `Pesticide_id`,
