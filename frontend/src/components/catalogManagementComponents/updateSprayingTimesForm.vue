<template>
     <Form @submit="newsprayingtimes.close = true, $emit('updateSprayingTimes-submit', newsprayingtimes)"
          ...
          <div class="row">
               <p class="col-sm-12 text-center functionName"><span class="fas fa-edit actionIcon"></span> Cập Nhật Lần Phun
                    Thuốc
               </p>
          </div>
          <div class="row content">
               ...
               <div class="col-sm-4">
                    ...
                    <div class="form-group">
                         <label for="precipitation" class="mt-3">Lượng mưa(mm)</label>
                    ...
                    <div class="form-group ">
                         ...
                         <Field name="solarradiation" class="form-control"
                              v-model="newsprayingtimes.SprayingTimes_solarRadiation"
