          ...
          <div class="row content">
               <div class="col-sm-6 mt-2">
                    ...
                    <div class="form-group ">
                         ...
                         <Field name="temperature" class="form-control" v-model="newfertilizertimes.FertilizerTimes_temperature"
               ...
               <div class="col-sm-6 ">
                    <div class="form-group">
                         ...
                         <Field name="developmentid" class="form-control" v-model="newfertilizertimes.DevelopmentStage_name">
                              <select class="form-control" v-model="newfertilizertimes.DevelopmentStage_name" name="developmentid"
                                   for="developmentid">
                    ...
                    <div class="form-group">
                         ...
                         <Field name="precipitation" class="form-control" v-model="newfertilizertimes.FertilizerTimes_precipitation"
