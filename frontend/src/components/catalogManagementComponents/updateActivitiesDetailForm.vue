<template>
     <Form @submit="newactivitiesDetail.close = true, $emit('updateActivitiesDetail-submit', newactivitiesDetail)"
          :validation-schema="schema" class="form container-fluid updateActivityDetailForm">
          <div class="row">
          ...
          <div class="row">
               <div class="col-sm-12 mt-2 mb-3 text-center">
                    ...
                    <span v-if="message2 == 'Cập nhật thành công.'" class="textMessage2 mt-2 mb-2" style="color:black;">
                         Cập nhật lần thực hiện hoạt động thành công</span>
                    <span v-if="message1 == 'Cập nhật không thành công.'" class="textMessage1 pt-2 pb-2"> Cập nhật
                         lần thực hiện hoạt động không thành công
                    </span>
               </div>
          </div>
...
.createActivityDetailForm,
.updateActivityDetailForm {
     margin: auto;
     padding: 20px;
     background: #FAFAFC;
