<template>
     <Form @submit="newepidemictimes.close = true, $emit('updateEpidemicTimes-submit', newepidemictimes)"
          ...
          <div class="row">
               <p class="col-sm-12 text-center functionName">CẬP NHẬT THÔNG TIN LẦN BỊ BỆNH DỊCH</p>
          </div>
               ...
               <div class="col-sm-6 mt-2">
                    ...
                    <div class="form-group ">
                         ...
                         <Field name="fertilizer" v-model="newepidemictimes.Epidemic_name">
                              <select class="selectBox form-control" v-model="newepidemictimes.Epidemic_name"
                    ...
                    <div class="form-group">
                         ...
                         <Field name="start" class="form-control" v-model="newepidemictimes.EpidemicTimes_startDate"
                              ...
                              <label v-if="newepidemictimes.EpidemicTimes_startDate == null"><i
               ...
               <div class="col-sm-6">
                    <div class="form-group">
                         ...
                         <Field name="developmentid" class="form-control" v-model="newepidemictimes.DevelopmentStage_name">
                              <select class="selectBox form-control" v-model="newepidemictimes.DevelopmentStage_name"
                    ...
                    <div class="form-group ">
                         ...
                         <Field name="harvendestDate" class="form-control" v-model="newepidemictimes.EpidemicTimes_endDate"
                              ...
                              <datepicker :enable-time-picker="false" :value="newepidemictimes.EpidemicTimes_endDate"
                                   ...
                                   @closed="getWeather" format="dd-MM-yyyy" v-bind:on-closed="false" :clearable="false">
                              </datepicker>
                              <label v-if="newepidemictimes.EpidemicTimes_endDate == null"><i
                                        style="color: #959595; position: absolute;z-index: 1; left: 5%; margin-top:8px;"
                                        class="far fa-calendar-alt"></i></label>
                         </Field>
                    </div>
